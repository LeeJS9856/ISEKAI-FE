...
import * as LAppDefine from '../live2d-library/lappdefine';

const DEFAULT_MODEL_ZIP = "https://cdn.jsdelivr.net/gh/guansss/pixi-live2d-display/test/assets/haru/haru.zip";
...
const Live2DViewer = ({ modelUrl = DEFAULT_MODEL_ZIP, modelConfig, webSocketUrl }: Live2DViewerProps) => {
